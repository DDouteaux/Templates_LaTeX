...
\newcommand\inclureRemerciements{true}   % Mettre les remerciements (true) ou pas (false)
\newcommand\inclureResume{true}          % Mettre le résumé (true) ou pas (false)
\newcommand\inclureAbstract{true}        % Mettre le résumé anglais (true) ou pas (false)
...
%
\newcommand\footerRight{\textbf{Décembre 2016}}                    % À gauche séparation du footer
\newcommand\footerLeft{\textbf{\thepage}}                          % À droite séparation du footer
\newcommand\headerText{\textbf{Template de document \LaTeX{}}}     % Texte de l'en-tête

...
\section{Tableaux}
\newpage
\input{text/Tableaux/coloration_lignes_colonnes.tex}

\section{\'Equations}
\newpage
\input{text/Equations/coloration_lignes_colonnes.tex}

\section{Polices}
\newpage
\input{text/Polices/utilisation_fontes.tex}

\section{Fichiers}
\newpage
\input{text/Fichiers/inclure_pdf.tex}
